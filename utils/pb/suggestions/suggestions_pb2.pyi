...
class InitOrderRequest(_message.Message):
    ...
    order_id: str
    items: _containers.RepeatedCompositeFieldContainer[BookOrder]
    user: User
    ...
    gift_wrapping: bool
    terms_accepted: bool
    def __init__(self, order_id: _Optional[str] = ..., items: _Optional[_Iterable[_Union[BookOrder, _Mapping]]] = ..., user: _Optional[_Union[User, _Mapping]] = ..., credit_card: _Optional[_Union[CreditCard, _Mapping]] = ..., user_comment: _Optional[str] = ..., billing_address: _Optional[_Union[Address, _Mapping]] = ..., shipping_method: _Optional[str] = ..., gift_wrapping: bool = ..., terms_accepted: bool = ...) -> None: ...
